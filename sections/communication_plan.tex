...
The communication plan was established to guarantee that the correct target audience receives the necessary information at the right time and through appropriate channels. The communication plan can be seen in Table.\:\ref{tab:communication_plan}.

\begin{table}[H]
    \centering
    \caption{The communication plan for the project.}
    \label{tab:communication_plan}
    \begin{tabularx}{\textwidth}{|X|X|X|c|X|X|} \hline
