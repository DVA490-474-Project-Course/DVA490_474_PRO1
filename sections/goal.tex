...
The goal of this project is to design and create one \ac{ssl}-RoboCup division B robot which complies with all \ac{ssl}-RoboCup regulations. Furthermore, the necessary software to control a full \ac{ssl}-RoboCup team is to be developed and run in simulation. This includes a peer-to-peer communication protocol, as well as a centralised strategy planner. These are to be completed before 2025-01-10.
