...
The handover schedule consists of an initial handover on January $10\text{th}$ $2025$. There is the possibility for a followup handover on February $14\text{th}$ $2025$ if the product from the initial handover was found unsatisfactory.
...
Comprehensive documentation regarding all the project information including user guides, design, changelog, \ac{api}, test and simulation results can all be accessed on the projects \href{https://github.com/DVA490-474-Project-Course}{GitHub}\footnote{https://github.com/DVA490-474-Project-Course} page. The GitHub page is public and available to everyone.
