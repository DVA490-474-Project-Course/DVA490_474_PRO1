...
\begin{itemize}
    ...
    \item Changes:
    \begin{itemize}
        \item Software: available from Git commit messages and in changelog file in each repositories docs directory on the projects GitHub.
    ...
    \item User manual:
    \begin{itemize}
        \item Software: available in user\_guide file in each repositories docs directory on the projects GitHub.
...
\begin{itemize}
    ...
    \item Developer guide: describe how to set up the project for development, code style, build instructions.
...
All documentation is to be in British English and must follow scientific writing standards. Software documentation is additionally gonna use \href{https://www.doxygen.nl/}{Doxygen}, all header files are to have comments in accordance with the Doxygen tool.
...
All software and hardware documentation will be stored on the projects \href{https://github.com/DVA490-474-Project-Course}{GitHub}\footnote{https://github.com/DVA490-474-Project-Course} page. This way of storing the documentation will ensure it is secure and accessible by everyone.
